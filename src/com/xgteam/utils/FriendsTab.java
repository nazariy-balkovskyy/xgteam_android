...
public class FriendsTab extends TabDefinition{
	private final int _tabTitleResourceId;
	  ...
	  */
	  public FriendsTab(int tabContentViewId, int tabLayoutId, int tabTitleResourceId, int tabTitleViewId, Fragment fragment) {
